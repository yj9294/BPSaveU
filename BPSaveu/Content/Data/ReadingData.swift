...
enum BPReadingItem: String, CaseIterable {
    ...
    var description: String {
        ...
        case .protect:
            return """
1. Understand blood pressure, protect health
...
1. https://www.jacc.org/doi/10.1016/S0735-1097%2802%2981088-9
2. https://www.jacc.org/doi/10.1016/j.jacasi.2023.02.001
"""
            
        case .eat:
            return """
2. Diet is related to blood pressure, learn to eat scientifically
...
Sources of information for the article:
1. https://www.jacc.org/doi/10.1016/j.jacc.2012.09.010
2. https://www.jacc.org/doi/10.1016/j.jacc.2017.10.011
"""
        case .exercise:
            return """
3. Regular exercise, blood pressure is no longer high
...
Sources of information for the article:
1. https://www.acsm.org/all-blog-posts/certification-blog/acsm-certified-blog/2020/02/11/blood-pressure-hypertension-exercise-cec-course
2. https://www.acsm.org/all-blog-posts/acsm-blog/acsm-blog/2017/12/01/new-high-blood-pressure-guidelines
"""
        case .heart:
            return """
4. Stop smoking and limit alcohol to protect heart health
